...
| Slicing — `overlay-controls` | `docs/superpowers/slices/overlay-controls.md` | 6 slices — 6 pending |
...
| Objections — `overlay-controls` | `docs/superpowers/objections/overlay-controls.md` | 12 objections — 12 pending |
...
| Choice stories — `overlay-controls` | `docs/superpowers/stories/overlay-controls.md` | 11 stories — 11 pending |
