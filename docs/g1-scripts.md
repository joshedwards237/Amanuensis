# G1 at ten seconds — nine scripts

Sized from the operator's own history: 68 takes, median 2.59 w/s spontaneous,
reading rate ~3.4 w/s. Each script is 33–35 words, which lands near **10 s**
read at a normal pace. G1 (PRD §2) is defined *at* ten seconds and every G1
figure this project has published was measured on a corpus that could not
contain one — §9 assigned the number to Phase 3 and Phase 3's own ≥ 60 s rule
forbade it.

Read at your ordinary pace. Do not rush and do not pad — a take that lands at
7 s or 13 s is still useful; one performed to hit a stopwatch is not.
Deliberately ordinary vocabulary: a decoder given unusual words emits more
tokens and takes longer, which would make the measurement about the prose.

---

**1.** The morning meeting ran long again, mostly because nobody had read the
